...
const Home1 = () => {
  ...
  return (
    <div>
      ...
      />
      <div
        className="absolute top-[350px] left-[calc(50vw-204px)] h-[67px] w-[408px]"
        style={{
          color: 'rgb(249, 159, 90)',
          fontSize: '40px',
          textAlign: 'center',
          cursor: 'pointer'
        }}
        ...
        <div className="relative h-full w-full">
          ...
          <div
            ...
            style={{
              ...
              lineHeight: '67px',
              textAlign: 'center',
              background: 'rgb(240, 145, 72)',
              border: '1px solid rgb(240, 145, 72)'
            }}
          />
        </div>
      </div>
      {open && <LoginModal defaultOpen={true} />}
    </div>
  );
};
